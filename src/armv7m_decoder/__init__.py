...
state, :func:`fetch_and_decode` for taking an instruction straight out of a byte
buffer (reporting a :class:`DecodedWord`), the :func:`disassemble` function for
assembler formatting, the ITSTATE helpers that carry an IT block's condition
across a stream (:func:`next_itstate`, :func:`current_cond`, :func:`in_it_block`),
the instruction-size helpers that settle how wide a word is before it is decoded
